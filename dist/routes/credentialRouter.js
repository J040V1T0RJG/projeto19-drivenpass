...
const credentialMiddleware = __importStar(require("../middlewares/credentialMiddleware"));
...
credentialRouter.delete("/credential/:credentialId/delete", credentialController.deleteCredential);
